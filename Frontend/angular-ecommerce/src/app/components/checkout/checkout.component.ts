...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reviewCartDetalis();

    // read the users email address from storage
    ...
    /* const startMonth: number = new Date().getMonth() + 1;
     ...
     this.shopFormService.getCreditCardYears().subscribe(
       data => {
         console.log("Retroved credit card years: " + JSON.stringify(data));
     ...
     this.shopFormService.getCountries().subscribe(
       data => {
         console.log("Retrived coutries: " + JSON.stringify(data));
         this.countries = data;
       });
  ...
  setupStripePaymentForm() {
    ...
    this.cardElement.on('change', (event: any) => {
      ...
      // get a handle to a card-errors element
  ...
  onSubmit() {
    ...
    if (this.checkoutFormGroup.invalid) {
      this.checkoutFormGroup.pristine;
      return;
    }
    ...
    console.log(`this.paymeny.amount: ${this.paymentInfo.amount}`);
          ...
          this.stripe.confirmCardPayment(paymentIntentResponse.client_secret,
            ...
            .then((result: any) => {
              ...
              if (result.error) {
                ...
                // call REST API cia CheckoutService
                this.checkoutService.placeOrder(purchase).subscribe({
                  next: (responese: any) => {
                    alert(`Your oredr has been recived. \nOrder tracking number: ${responese.orderTrackingNumber}`);
  ...
  handleMonthsAndYears() {
    ...
    // if the current year equals the selected year, than start with the current month
